...
$page->addPageFunctionsMenuItem('admMenuItemPreferencesLists', $gL10n->get('PLG_REMOVE_GENDER_LANGUAGE_EDIT_REPLACEMENTS'),
        ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER . PLUGIN_SUBFOLDER .'/edit_replacements.php',  'bi-pencil-fill');
            ...
            success: function(data) {
                if (data === "create" || data === "delete" || data === "restore"|| data === "replace") {
                    ...
                    if (data === "create" || data === "delete" || data === "restore") {
                        setTimeout(3000);
                        window.location.replace("'. ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER . PLUGIN_SUBFOLDER .'/remove_gender_language.php");
                    }
                } else {
...
{
    $formCreate = new HtmlForm('remove_gender_language_create_form', SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER . PLUGIN_SUBFOLDER .'/remove_gender_language_function.php', array('mode' => 'create')), $page, array('class' => 'form-remove_gender_language'));
...
{
    $formBackupAndRestore = new HtmlForm('remove_gender_language_backup_form', SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER . PLUGIN_SUBFOLDER .'/remove_gender_language_function.php', array('mode' => 'restore_delete')), $page, array('class' => 'form-remove_gender_language'));
...
$formUndo = new HtmlForm('remove_gender_language_undo_form', SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER . PLUGIN_SUBFOLDER .'/remove_gender_language_function.php', array('mode' => 'replace')), $page, array('class' => 'form-remove_gender_language'));
