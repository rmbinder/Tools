 ...
 * Stand 31.08.2020
 *
 * Dieses Admidio-Plugin zeigt mehrfache Rollenmitgliedschaften an.
 * 
 * Author: rmb
 *
...
{
    $columnValues = array();
    $columnValues[] = '<a href="'. ADMIDIO_URL . FOLDER_MODULES . '/profile/profile.php?user_id='. $row['mem_usr_id']. '">'.$row['last_name'].', '.$row['first_name']. '</a>';
