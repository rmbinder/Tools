...
/**
 ***********************************************************************************************
 * Installation routine for the Admidio plugin tools
 *
...
try {
    ...
    $role->readDataByColumns(array(
        ...
        'rol_name' => $gL10n->get('PLG_TOOLS_ACCESS_TO_PLUGIN'),
        'rol_description' => $gL10n->get('PLG_TOOLS_ACCESS_TO_PLUGIN_DESC')
    ));
    ...
    if ($role->getValue('rol_id') === 0) 
    {
        ...
        $role->setValue('rol_name', $gL10n->get('PLG_TOOLS_ACCESS_TO_PLUGIN'));
        $role->setValue('rol_description', $gL10n->get('PLG_TOOLS_ACCESS_TO_PLUGIN_DESC'));
        $role->save();
    }
    ...
    $menu->setValue('men_icon', 'tools');
    $menu->setValue('men_name', 'PLG_TOOLS_NAME');
    $menu->setValue('men_description', 'PLG_TOOLS_NAME_DESC');
    $menu->save();
